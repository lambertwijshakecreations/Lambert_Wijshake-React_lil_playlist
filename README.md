Dit was de eerste eindopdracht waarbij ik met React een playlist heb gemaakt. Deze versie heb ik naast de gewone requerments een remove all button toegevoegd en een Router toegepast.
